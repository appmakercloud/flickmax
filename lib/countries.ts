...
export const countries: Country[] = [
  ...
  { code: 'AR', name: 'Argentina', currency: 'ARS', locale: 'es-AR', marketId: 'es-AR', phoneNumber: '011 5984-0787', flag: '🇦🇷' },
  ...
  { code: 'BR', name: 'Brazil', currency: 'BRL', locale: 'pt-BR', marketId: 'pt-BR', phoneNumber: '(011) 3958-5682', flag: '🇧🇷' },
  ...
  { code: 'RU', name: 'Russia', currency: 'RUB', locale: 'ru-RU', marketId: 'ru-RU', phoneNumber: '7 495 463 17 27', flag: '🇷🇺' },
  ...
  { code: 'TR', name: 'Turkey', currency: 'TRY', locale: 'tr-TR', marketId: 'tr-TR', phoneNumber: '0 850 390 21 86', flag: '🇹🇷' },
